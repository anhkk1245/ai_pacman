    ...
    while not pq.isEmpty():
        ...
        if top[0] not in visited:
            ...
            for successor in problem.getSuccessors(top[0]):
                if successor[0] not in visited:
                    pq.push((successor[0], top[1] + [successor[1]], top[2] + successor[2]), top[2] + successor[2])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not pq.isEmpty():
        ...
        if top[0] not in visited:
            ...
            for successor in problem.getSuccessors(top[0]):
                if successor[0] not in visited:
                    pq.push((successor[0], top[1] + [successor[1]], top[2] + successor[2]), top[2] + successor[2] + heuristic(successor[0], problem))
